    ...
    <FullLayout>
      <Container sx={{ paddingY: 6 }}>
        <Typography>
          ...
          <p>
            By accessing this Website, accessible from www.kryptos.news, you are
          ...
          <p>
            ...
            materials on SBIGTECH Vietnam&amp;apos;s Website for personal,
          ...
          <ul>
            ...
            <li>
              attempt to reverse engineer any software contained on SBIGTECH
              Vietnam&amp;apos;s Website;
            </li>
            <li>
          ...
          <p>
            This will let SBIGTECH Vietnam to terminate upon violations of any
            ...
            in your possession whether it is printed or electronic format. These
          ...
          <p>
            All the materials on SBIGTECH Vietnam’s Website are provided &amp;quot;as
            is&amp;quot;. SBIGTECH Vietnam makes no warranties, may it be expressed or
            implied, therefore negates all other warranties. Furthermore,
            SBIGTECH Vietnam does not make any representations concerning the
          ...
          <p>
            SBIGTECH Vietnam or its suppliers will not be hold accountable for
            any damages that will arise with the use or inability to use the
            materials on SBIGTECH Vietnam’s Website, even if SBIGTECH Vietnam or
          ...
          <p>
            The materials appearing on SBIGTECH Vietnam’s Website may include
            technical, typographical, or photographic errors. SBIGTECH Vietnam
            will not promise that any of the materials in this Website are
            accurate, complete, or current. SBIGTECH Vietnam may change the
            materials contained on its Website at any time without notice.
            SBIGTECH Vietnam does not make any commitment to update the
            materials.
          </p>
          ...
          <p>
            SBIGTECH Vietnam has not reviewed all of the sites linked to its
            Website and is not responsible for the contents of any such linked
            site. The presence of any link does not imply endorsement by
            SBIGTECH Vietnam of the site. The use of any linked website is at
            the user’s own risk.
          </p>
          ...
          <p>
            SBIGTECH Vietnam may revise these Terms of Use for its Website at
          ...
          <p>
            Any claim related to SBIGTECH Vietnam&amp;apos;s Website shall be
            governed by the laws of vn without regards to its conflict of law
            provisions.
          </p>
        </Typography>
      </Container>
